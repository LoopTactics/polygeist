...
public:
  ...
  mlir::Operation *buildComprehension(const lang::Comprehension &c);
...
private:
  ...
  // Get MLIR tensor type from 'tensorType' with #n dimensions.
  mlir::Type getTensorType(const lang::TensorType &tensorType, size_t ndims);
